...
window.addClassesToRows = function addClassesToRows(TD, row, column, prop, value, cellProperties) {
...
window.drawCheckboxInRowHeaders = function drawCheckboxInRowHeaders(row, TH) {
...
window.alignHeaders = function alignHeaders(column, TH) {
    if (column < 0) {
        return;
    }
...
window.changeCheckboxCell = function changeCheckboxCell(event, coords) {
